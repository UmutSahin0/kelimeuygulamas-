...
form=tk.Tk()
#başlık ekleme
form.title("İlk deneme")
#boyutlandırma
form.geometry("500x500+500+350")


but=tk.Button(form,text="next",command=next_word)
form.bind("<Return>",lambda event:next_word(ceviri))
but.pack(pady=20)


but2=tk.Button(form,text="show",command=show_answer)
...
#butonunu oluşturma
but=tk.Button(form,text="iceri aktar",command=iceri_aktar)
...
#yukleme butonu
but_yukle=tk.Button(form,text="aktarılanları yükle",command=yukle)
